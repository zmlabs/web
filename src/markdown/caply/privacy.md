...
* Developer Validation API  
    * *Purpose:* verify subscription with the Transaction ID and return usage quota  
    * *Storage:* real-time check only; no persistent storage

* Translation Service  
    * *Purpose:* translate de-identified text (Pro tier, optional)  
    * *Settings:* logging **disabled**  
    * *Privacy notice:* <https://openrouter.ai/privacy>
